...
pub(crate) fn print_ani_result(ani_result: &AniResult, pseudotax: bool, writer: &mut dyn Write) {
...
pub(crate) fn print_header(pseudotax: bool, writer: &mut dyn Write, estimate_unknown: bool) {
    if !pseudotax{
        writeln!(writer,
